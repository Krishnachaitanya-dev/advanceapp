    ...
    <AppLayout>
      <div className="glass-card p-6 bg-gradient-to-br from-blue-50 to-purple-50 border border-blue-200">
        ...
        <div className="space-y-6 text-slate-700">
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-800 mb-3">How We Use Your Information</h3>
            <ul className="list-disc list-inside space-y-1 text-slate-600">
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-800 mb-3">Information Sharing</h3>
            <p className="mb-3">
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-800 mb-3">Location Data Usage</h3>
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-800 mb-3">Data Retention</h3>
            <ul className="list-disc list-inside space-y-1 text-slate-600">
          ...
          <section>
            <h3 className="text-lg font-semibold text-slate-800 mb-3">Policy Updates</h3>
            <p className="text-slate-600">
